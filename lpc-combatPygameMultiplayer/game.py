...
from tank import Ball
from hud import Hud
from tank_colision import collision_tank_or_ball
import keystrokes
import elements
...
class Game:
    ...
    def actions(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                keystrokes.keys_down(event, self.__list_of_tank, self, self.__counter)

            if event.type == pygame.KEYUP:
                keystrokes.keys_up(event, self.__list_of_tank)

            if event.type == pygame.JOYHATMOTION:
                keystrokes.hatdown(event, self.__list_of_tank)

            if event.type == pygame.JOYBUTTONDOWN:
                keystrokes.buttondown(event, self.__list_of_tank)

            if event.type == pygame.JOYBUTTONUP:
                keystrokes.buttonup(event, self.__list_of_tank)
