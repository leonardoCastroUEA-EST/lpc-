...
class Arena:
    def __init__(self):
        ...
        self.__list_spawn = []
        up_wall = pygame.draw.rect(Config.screen, Config.gray, (0, 60, 1366, Config.size_walls))
        down_wall = pygame.draw.rect(Config.screen, Config.gray, (0, Config.size_screen[1] - Config.size_walls, 1366, Config.size_walls))
        right_wall = pygame.draw.rect(Config.screen, Config.gray, (Config.size_screen[0] - Config.size_walls, 60, Config.size_walls, 660))
        left_wall = pygame.draw.rect(Config.screen, Config.gray, (0, 60, Config.size_walls, 660))
        self.__list_wall = [up_wall, down_wall, right_wall, left_wall]
    ...
    def create_arena(self, file_name: str):
        mc = 1332 / 222
        ml = 620 / 40
