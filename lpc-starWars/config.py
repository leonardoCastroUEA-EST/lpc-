...
class Config:
    ...
    # sounds
    falcon_shoot = pygame.mixer.Sound("sounds/Millenium Falcon.wav")
    ties_shoot = pygame.mixer.Sound("sounds/TIEFighter.wav")
    asteroid_destroyed = pygame.mixer.Sound("sounds/asteroidExplosion.wav")
    wings_shoot = pygame.mixer.Sound("sounds/X-Wing.wav")
