...
class Ball:
    ...
    def change_direction(
        ...
        if self.coordinate.x == brick.coordinate.x:
            percents = (self.coordinate.y - brick.coordinate.y) / \
                brick.dimension.height
            ...
            percents = (self.coordinate.x - brick.coordinate.x) / \
                brick.dimension.width
    ...
    def draw(self, screen: Screen):  # TODO: Fires at a coordinate
        ...
        self.coordinate.x += Settings.BALL_DRAW_VELOCITY * self.x_velocity
        self.coordinate.y += Settings.BALL_DRAW_VELOCITY * self.y_velocity
        pygame.draw.rect(
            screen.surface,
